...
import { defineAsyncComponent, ref, h, defineComponent, type Component } from 'vue'
...
const AsyncUserProfile = defineAsyncComponent({
  ...
  loader: async (): Promise<Component> => { // Явно указываем тип возвращаемого значения
    try {
      ...
      const userProfileComponent = defineComponent({
        ...
        setup() {
          ...
          return () => h('div', { class: 'profile-card' }, [
            ...
            h('p', [h('strong', 'Статус: '), data.isActive ? 'Активен' : 'Неактивен']),
